...
**Last updated:** 2026-06-16 (I.21 DTW ❌ — 새 정보이나 방향 비정렬. 모양 정보 3회 확인. 신호 표현 탐색 종결)
**Status:** 🔬 [I] 빈도(9축)+거래당(horizon)+표현(모양/DTW) 전부 소진. 4h 단일 유클리드 최종. 키우는 길=레버리지(16). 감쇠 판정(shadow) 선결
