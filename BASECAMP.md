...
**Last updated:** 2026-06-15 (I.18 MTF 봉 ❌ — 봉=새정보(redundant 아님)이나 결합 무용. 단일 4h 0.084% 1x 확정)
**Status:** 🔬 [I] 빈도 개선 전면 소진(9축+MTF). 키우는 길=레버리지(16, 감쇠 의존). 감쇠 판정(shadow)이 모든 것의 선결
