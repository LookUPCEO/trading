...
**Last updated:** 2026-06-10 (SOL.2 — 동일 182일 SOL·ETH **둘 다 edge 없음**, ETH 4h 감쇠 확정. 방법은 SOL 일반화(부호일치 0.71))
**Status:** 🔬 [SOL] 이 윈도우 ❌ (양 자산 최근 감쇠). shadow 전향이 감쇠 최종판정 (선결). [I] ETH full = 역사적
