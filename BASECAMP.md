...
**Last updated:** 2026-06-15 (I.16 레버리지 — 처음으로 0.5% 조건부 도달(4h 단독 5x +0.74%/파산4%), 단 감쇠 의존 극심)
**Status:** 🔬 [I] 1x 천장은 0.084% 였으나 레버리지로 0.5% 조건부 가능 — edge 지속 가정 위. 지속 확인(shadow)이 레버리지 결정 선결
