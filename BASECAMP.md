...
**Last updated:** 2026-06-10 (I.7 multi-horizon ❌ 빈도 못 풂 (신호 중복). **SOL.2 감쇠 정정: full DB 로 최근 4h +51.8 양수**. 합의 hit 0.81)
**Status:** 🔬 [I] 단일 4h 운영점 확정 (빈도 6축 닫힘). 감쇠 open — shadow 전향이 판정. SOL 백필 옵션
