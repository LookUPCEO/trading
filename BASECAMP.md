...
**Last updated:** 2026-06-10 (I.6-5 — thr 소수점: 점프 ~0.70 실재(ramp), 0.70 확정. **일수익 4.5축 전부 닫힘 = ETH 최종 운영점**)
**Status:** 🔬 [I] 유사도 거래 — ETH 운영점 확정, 개선 공간 소진. shadow 가동 중 (전향 2건). 형제: shadow누적/백필/[I]밖(SOL)
