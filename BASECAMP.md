...
**Last updated:** 2026-06-14 (I.10-1 보완 불가 확정 — 1h&4h 0.75 는 n=4 노이즈(표본 늘리니 0.38 중복). in-data 보완 완전 소진)
**Status:** 🔬 [I] in-data 개선 완전 소진 (10축+짝). shadow 전향(감쇠)이 유일 미해결. SOL 백필 옵션
