...
**Last updated:** 2026-06-07 (I.6-3 — thr 축도 닫힘: 0.70 = train/test 동시 균형점. **일수익 3축 전부 닫힘, [I] 단독 = 목표 30%**)
**Status:** 🔬 [I] 유사도 거래 — 파라미터 공간 소진 (정의/청산/thr). shadow 가동 중 (진짜인지 선결). 형제: 백필/구조분해/[I]밖
