...
**마지막 업데이트**: 2026-06-15 (I.18 MTF 봉 ❌ — 봉=새정보(redundant 아님, 게이트 통과, 8단계와 다름)이나 결합 무용: 유사도 추가 hit 0.68→0.58(14단계 funding 패턴), AND/OR 모멘텀 hit 0.44 역예측. 교훈: 비중복≠유용, 21차원은 방향 튜닝 공간. 단일 4h 0.084% 1x 확정, 빈도 개선 전부 소진. 키우는 길=레버리지(16, 감쇠 의존). 이전: I.17 방향구조)
