...
**마지막 업데이트**: 2026-06-17 (I.26 down 전면 재검증 ❌ — dense stride=1 825k쿼리로 down-4h-thr0.70 독립 n 17→190 보강. 25단계 hit 0.765 = n=17 플룩 확정(n=190 → 0.484 코인플립, regime 의존). 임계×horizon 24셀 전부 gross<fee·net음수·hit 0.48~0.60. Bonferroni-24 거래가능 0. 강도순 독립greedy=선택lookahead 인공물 발견·제거(시간순만 유효, full=−15.5 일치). 강세장·drift≈0 구조적. 4h 양방향 합산 재확정. 라이브 49338 유지. 이전: I.25 방향별 horizon ❌)
