...
**마지막 업데이트**: 2026-06-17 (I.25 방향별 최적 horizon ❌ — 엘리베이터 가설 부분진실(down 단기 15~20m hit 0.65~0.67 > up 0.58 = 하락 빠름 실재) but 그 영역 gross<fee(작은 움직임, fee/|move| 벽) + OOS 불안정 → 거래불가. down 2~3h 역신호, down 4h hit 0.765지만 test n=4 판정불능. 롱/숏 둘 다 거래가능 최적=4h → 방향분리=현행 4h합산 동일(+51.8bp/day, 충돌0), 빈도·일수익 개선 0. 4h 양방향 합산 재확정. 라이브 49338 유지. 이전: I.24 hold 분단위/조건부 과적합)
