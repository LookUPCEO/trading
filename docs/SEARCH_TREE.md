...
**마지막 업데이트**: 2026-06-17 (I.27 하락 전용 시스템 ❌ — horizon(cross-day 30m~2d)·표현(47라벨+GBM 최대자유)·임계 3축 독립 최적화 후에도 OOS edge 0, Bonferroni-22 생존 0. 긴 horizon 악화(2d hit 0.449 코인미만), 표현 AUC(down) 0.51~0.52(무작위), 하락 선행지표(OBI/flow) 부재. 유일=단기 30m 약한 방향성(hit 0.57) sub-fee. 큰상승=stairs(식별가능)/큰하락=elevator(무특징) 구조적 비대칭. 하락 분기 완전 종결(25→26→27). 4h 양방향 합산 재확정. sanity UP-4h hit 0.661 재현. 라이브 49338 유지. 이전: I.26 down 표본보강 ❌)
