...
**마지막 업데이트**: 2026-06-10 (I.7 multi-horizon ❌ — 신호 동시발생 동방향 100%(중복), 자본분산 +5.0<단일4h +8.4 = 빈도 못 풂. 단 ①SOL.2 감쇠 정정: full DB 로 최근 4h +51.8 양수(182일 DB 인공물이었음, 감쇠 open) ②합의 3+ hit 0.81=질 강화(빈도는 감소). 단일 4h 운영점 유지. shadow 전향이 감쇠 최종판정. 이전: SOL.2, I.6-5)
