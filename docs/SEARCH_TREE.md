...
- I.6 ⬜ (남은 형제들):
  - **shadow 결과 누적 대기** (가동 중)
  - **수집 공백 백필** (5/1~6/6 — pool·정규화 최신화)
  - **진입 빈도 확대** (thr 0.68 사전등록 / 시간대·구조 분해 — 일수익 병목)
  - down-lean 약함 / 2h-3h 골 원리 분해
...
**마지막 업데이트**: 2026-06-07 (I.6-2 재예측 갱신 ❌ — V1 연장+전환 +73.8 ≈ FIXED 동률 (flip 2/79회 — 반대신호가 안 옴), V2 소멸청산 -0.2 (hold 8분 즉시청산화). 청산 개선 8규칙 전패 → 고정 4h hold 확정. 병목 = 진입 빈도. shadow 가동 중. 이전: I.6-1 shadow 가동+가격규칙 전패)
