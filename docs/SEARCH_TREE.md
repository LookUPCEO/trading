...
**마지막 업데이트**: 2026-06-14 (I.9 합의 두 길 ❌ 일수익 — k 단조 hit 0.58→0.78/net→+284(질 신호 확정), 단 A 희소(size1 +6.4<15.1, 레버=위험)·B 합의도 0.65 fee 못넘음, test 현행 넘는 셀 0. 일수익 9축 전부 닫힘=[I] 최종형. 합의 k=신뢰도지표 → shadow k 로깅 후속. shadow 7일째 outcome 2(감쇠 판정 미정). 이전: I.8 경로)
