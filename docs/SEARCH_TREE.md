...
- I.6 ⬜ (남은 형제들):
  - **shadow 결과 누적 대기** (가동 중 — 2025Q3+ 미확정 해소가 선결)
  - **수집 공백 백필** (5/1~6/6 — pool·정규화 최신화)
  - 구조 분해 (US 세션/down-lean/2h-3h 골 — 사전등록 후)
  - [I] 밖: 타 신호와 결합 / 사이징 (edge 확정 후 문제)
...
**마지막 업데이트**: 2026-06-07 (I.6-3 thr 곡선 ❌ 개선 없음 — thr0.70 이 train/test 동시 균형점 (결합 +18.99→+8.08 둘 다 1위), fee 하한 0.67~0.68 적중, thr<0.67 은 빈도 늘수록 손해. 일수익 3축 (정의/청산/thr) 전부 닫힘 — 빈도 = 신호 본질. [I] 단독 = 목표의 30%. shadow 가동 중)
