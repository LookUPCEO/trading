...
**마지막 업데이트**: 2026-06-22 (I.27-1 하락 단기 분단위(5~50분) ❌ — 감사: 27 shortest=30m·26=15m → 5/10/25/40/50m 미탐 맞음, dense 로 채움. 전 셀 net 음수·Bonf-24 생존 0. 핵심: '하락=급락이라 폭 크다' 반증 — down |move|=up 의 ~절반(5m 22 vs 47bp), kNN down-lean 은 급락 아닌 작은 하락 고름(급락=사전 미식별). 짧은 하락=정확도↓+폭↓ 둘 다 → fee/move 벽 더 강함. 25 의 15m/20m 0.66=stride10 플룩(dense 0.58/0.60). 하락 예측불가 최종 확정(분단위, 25→26→27→27-1 전부 ❌). 4h 양방향 합산 재확정. 라이브 49338 유지. 이전: I.27 하락 전용 시스템 ❌)
