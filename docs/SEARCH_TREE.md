...
**마지막 업데이트**: 2026-06-22 (I.28 하락 특화 라벨 신설 ❌ — 하락 전조 10라벨(지지붕괴/비대칭호가/하방변동성/매도공격성, 1초 OB·체결 파생) 신설, 6개는 기존 47과 진짜 다른 정보(corr<0.2). 그러나 down AUC 안 올림(47 0.509→47+10 0.510 Δ+0.001=노이즈), 새 라벨 단독 0.507 무작위, 거래화 short net−11 실패. → 라벨 부족 아니라 시장 본질: 큰 하락은 OB/체결 사전상태에 안 새김(효율+급락 돌발). 유일 한계: 청산 데이터 미수집(H 분기 ⬜). 하락 분기 5단계 모두 ❌(25→26→27→27-1→28). 4h 양방향 합산 재확정. 라이브 49338 유지. 이전: I.27-1 하락 분단위 ❌)
