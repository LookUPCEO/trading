...
**마지막 업데이트**: 2026-06-15 (I.19 긴 horizon — "4h 단조 peak" 거짓(6h/8h hit<0.5 반전, 12h/1d 회복=비단조). 1d 가 새 lead: hit 0.64/+162bp/일수익 +49.7(≫4h)/3년 전부 양수/독립+gap audit 생존 — 단 day-CI [-3,+168] 0포함(미확정), 6h/8h 반전 미설명, 자본중첩. 4h 확정 유지, 1d=전향검증 lead. 이전: I.18 MTF봉)
