...
**마지막 업데이트**: 2026-06-16 (I.20 1d 기각 — "+49.7/day"는 자본중첩 인공물(비중첩 단일포지션 강제 시 hit 0.52·-0.76/day). 클러스터 2.8신호/일이 같은 1d 움직임 중복계상+up편향. 19 caveat #3 적중. 거래당 축(horizon)도 닫힘. 4h 단일 = [I] 최종 확정. 빈도(9축)+거래당(horizon) 전부 소진, 키우는 길=레버리지(16, 감쇠 의존). 감쇠 판정(shadow)이 유일 미해결. 이전: I.19 긴horizon)
