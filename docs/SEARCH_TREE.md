...
**마지막 업데이트**: 2026-06-14 (I.10-1 보완 불가 확정 — 1h&4h 0.75 는 n=4 노이즈(thr0.65 표본 늘리니 0.38=중복). 10짝 전부 강신호域 redundant, fee 넘는 보완 짝 없음. 짝-union test 음수. horizon=같은정보 시간변형 재확인. in-data 보완 완전 소진 = [I] 최종형. shadow 전향이 유일 미해결. 이전: I.10 보완)
