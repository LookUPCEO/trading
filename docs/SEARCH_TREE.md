...
- I.6 ⬜ (남은 형제들):
  - **shadow 결과 누적 대기** (가동 중 — 진짜인지 선결)
  - **수집 공백 백필** (5/1~6/6)
  - [I] 밖: 타 신호 결합 / 사이징 (edge 확정 후)
...
**마지막 업데이트**: 2026-06-07 (I.6-4 thr 분포 ❌ — 저밴드 이익거래 45% 실존하나 식별 부분집합 OOS 전멸 0/5. 0.70 = 분포 점프 (승률 46→58%, med -7→+18) = 진짜 경계. 빈도 한계 분포로 확정. 일수익 4축 (정의/청산/thr평균/thr분포) 소진 — shadow 누적·백필·[I]밖 남음)
