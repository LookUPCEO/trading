...
**마지막 업데이트**: 2026-06-15 (I.17 방향 구조 ❌ — 약신호 사전식별 3번째 실패. 183 구조×thr 중 OOS 95% 생존 1개(우연 미만, Bonf 미생존), 눌림목 직관 hit 0.445 역신호, all-up=k5 재탕. 6-4/10-2/17 = 약신호 사전식별 불가 3회 확인. 빈도 개선 전부 소진, 0.084% 1x 천장 재확정. 키우는 길=16단계 레버리지(감쇠 의존)뿐. 남은 건 감쇠 판정(shadow). 이전: I.16 레버리지)
