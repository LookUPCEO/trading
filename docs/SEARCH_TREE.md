...
**마지막 업데이트**: 2026-06-15 (I.16 레버리지 — 처음으로 0.5% 조건부 도달: 4h 단독(OOS 양수·f* 안정 16~18x, 14단계 합의와 다름)에 5x=+0.74%/파산4%(full). 단 감쇠 의존 극심(절반감쇠 5x 파산18.5%, 소멸 57%). 레버리지=증폭이지 생성 아님. 지속 확인(shadow) 전 저배율 2~3x(+0.17~0.36%/파산~1%)가 신중한 천장. 0.084%는 1x 기준 교정. 이전: I.14 개선소진)
