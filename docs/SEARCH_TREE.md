...
- I.6 ⬜ (남은 형제들):
  - **shadow 결과 누적 대기** (가동 중 — 2025Q3+ 미확정의 해소는 시간)
  - **수집 공백 백필** (5/1~6/6, Bybit/Tardis — pool·정규화 최신화)
  - **구조 분해**: down-lean 약함 / 2h-3h 골 / 시간대(US 세션) — 원리
  - **빈도 확대** (thr 0.68 등 — 사전 등록 후만) / 다른 청산공간 (방향성: 들고 가라)
...
**마지막 업데이트**: 2026-06-07 (I.6-1 — A 능동청산 사전등록 5규칙 전패 (FIXED +74.7 최고, 손절 최악 +12) = 고정 hold 유지. B shadow 데몬 가동 (replay 일치 0.00e+00 bit-identical 검증 후). 수집 재개 겸용. 이제 2025Q3+ 미확정은 시간이 해소. 이전: I.6a 닮음정의 ❌, I.5 4h Bonf 생존)
